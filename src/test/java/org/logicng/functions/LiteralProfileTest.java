...
public class LiteralProfileTest {
  ...
  public void testConstants() {
    Assert.assertEquals(new HashMap<Literal, Integer>(), f.verum().apply(litProfile, true));
    Assert.assertEquals(new HashMap<Literal, Integer>(), f.verum().apply(litProfile, false));
    Assert.assertEquals(new HashMap<Literal, Integer>(), f.falsum().apply(litProfile, true));
    Assert.assertEquals(new HashMap<Literal, Integer>(), f.falsum().apply(litProfile, false));
  }
