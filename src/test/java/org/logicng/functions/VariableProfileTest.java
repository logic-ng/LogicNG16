...
public class VariableProfileTest {
  ...
  public void testConstants() {
    Assert.assertEquals(new HashMap<Literal, Integer>(), f.verum().apply(varProfile, true));
    Assert.assertEquals(new HashMap<Literal, Integer>(), f.verum().apply(varProfile, false));
    Assert.assertEquals(new HashMap<Literal, Integer>(), f.falsum().apply(varProfile, true));
    Assert.assertEquals(new HashMap<Literal, Integer>(), f.falsum().apply(varProfile, false));
  }
