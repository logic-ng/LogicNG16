...
public abstract class Constant extends Formula {
  ...
  private static final SortedSet<Variable> EMPTY_VARIABLE_SET = new TreeSet<Variable>();
  private static final SortedSet<Literal> EMPTY_LITERAL_SET = new TreeSet<Literal>();
